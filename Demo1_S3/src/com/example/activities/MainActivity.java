...
import com.example.fragments.AbaoutFragment;
import com.example.fragments.CountriesContentFragment;
...
public class MainActivity extends ActionBarActivity{
	...
	private Fragment[] fragments = new Fragment[]{new CountriesContentFragment(), new AbaoutFragment()};
	@Override
	...
	public void setContent(int index){
		...
		case 1:
			...
			actionBar.setTitle(drawerOptions[1]);
			break;
		}
